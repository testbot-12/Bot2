...
const permission = [`100065445284007`,``];
if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only Sakibin⛔", event.threadID, event.messageID);
