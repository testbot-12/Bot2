...
var StatRow = class extends YTNode {
  constructor(data2) {
    super();
    this.title = new Text2(data2.title);
    this.contents = new Text2(data2.contents);
  }
};
...
var SubscribeButton = class extends YTNode {
  constructor(data2) {
    var _a3, _b;
    super();
    this.title = new Text2(data2.buttonText);
...
var Comment = class extends YTNode {
  constructor(data2) {
    ...
    this.vote_status = data2.voteStatus;
    this.vote_count = data2.voteCount ? new Text2(data2.voteCount).toString() : "0";
...
var Playlist = class extends YTNode {
  constructor(data2) {
    ...
    this.title = new Text2(data2.title);
    this.author = ((_a3 = data2.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text2(data2.shortBylineText) : new Author_default(data2.longBylineText, data2.ownerBadges, null);
...
var GridMix = class extends YTNode {
  constructor(data2) {
    ...
    this.id = data2.playlistId;
    this.title = new Text2(data2.title);
    this.author = ((_a3 = data2.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text2(data2.shortBylineText) : ((_b = data2.longBylineText) === null || _b === void 0 ? void 0 : _b.simpleText) ? new Text2(data2.longBylineText) : null;
    this.thumbnails = Thumbnail.fromResponse(data2.thumbnail);
    this.video_count = new Text2(data2.videoCountText);
    this.video_count_short = new Text2(data2.videoCountShortText);
    this.endpoint = new NavigationEndpoint_default(data2.navigationEndpoint);
...
var GridMovie = class extends YTNode {
  constructor(data2) {
    ...
    this.title = new Text2(data2.title);
    this.thumbnails = Thumbnail.fromResponse(data2.thumbnail);
    this.duration = data2.lengthText ? new Text2(data2.lengthText) : (length_alt === null || length_alt === void 0 ? void 0 : length_alt.text) ? new Text2(length_alt.text) : null;
    this.endpoint = new NavigationEndpoint_default(data2.navigationEndpoint);
    this.badges = parser_default.parseArray(data2.badges, MetadataBadge_default);
    this.metadata = new Text2(data2.metadata);
    this.thumbnail_overlays = parser_default.parseArray(data2.thumbnailOverlays);
...
var MusicMultiSelectMenu = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "title") && Reflect.has(data2.title, "musicMenuTitleRenderer")) {
      this.title = new Text2((_a3 = data2.title.musicMenuTitleRenderer) === null || _a3 === void 0 ? void 0 : _a3.primaryText);
    }
...
var PlaylistPanelVideo = class extends YTNode {
  constructor(data2) {
    ...
    const album = (_a3 = new Text2(data2.longBylineText).runs) === null || _a3 === void 0 ? void 0 : _a3.find((run) => {
      var _a4, _b2, _c2;
    ...
    const artists = (_b = new Text2(data2.longBylineText).runs) === null || _b === void 0 ? void 0 : _b.filter((run) => {
      var _a4, _b2, _c2;
      return (_c2 = (_b2 = (_a4 = run.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.browseId) === null || _c2 === void 0 ? void 0 : _c2.startsWith("UC");
    });
    ...
    if (album) {
      this.album = {
        ...
        name: album.text,
        year: (_e = new Text2(data2.longBylineText).runs) === null || _e === void 0 ? void 0 : _e.slice(-1)[0].text,
  ...
  constructor(data2) {
    ...
    if (playlistData) {
      this.playlist = {
        ...
        author: ((_d = playlistData.shortBylineText) === null || _d === void 0 ? void 0 : _d.simpleText) ? new Text2(playlistData.shortBylineText) : new Author_default(playlistData.longBylineText),
...
var VideoPrimaryInfo = class extends YTNode {
  constructor(data2) {
    ...
    this.view_count = new Text2((_b = (_a3 = data2.viewCount) === null || _a3 === void 0 ? void 0 : _a3.videoViewCountRenderer) === null || _b === void 0 ? void 0 : _b.viewCount);
    this.short_view_count = new Text2((_d = (_c = data2.viewCount) === null || _c === void 0 ? void 0 : _c.videoViewCountRenderer) === null || _d === void 0 ? void 0 : _d.shortViewCount);
    this.badges = parser_default.parseArray(data2.badges, MetadataBadge_default);
...
function parseResponse(data2) {
  ...
  const streaming_data = data2.streamingData ? {
    ...
    formats: parseFormats(data2.streamingData.formats),
    adaptive_formats: parseFormats(data2.streamingData.adaptiveFormats),
  ...
  const engagement_panels = (_c = data2.engagementPanels) === null || _c === void 0 ? void 0 : _c.map((e) => {
...
var Playlist2 = class extends Feed_default {
  constructor(actions, data2, already_parsed = false) {
    ...
    this.info = Object.assign(Object.assign({}, (_a3 = this.page.metadata) === null || _a3 === void 0 ? void 0 : _a3.item().as(PlaylistMetadata_default)), {
...
var MediaInfo = class {
  ...
  toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      let storyboards;
      if (options.include_thumbnails && ((_a3 = __classPrivateFieldGet(this, _MediaInfo_page, "f")[0].storyboards) === null || _a3 === void 0 ? void 0 : _a3.is(PlayerStoryboardSpec_default))) {
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    __classPrivateFieldSet(this, _Author_nav_text, new Text2(item), "f");
