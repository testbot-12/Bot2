...
var Playlist = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text2(data.title);
    this.author = ((_a4 = data.shortBylineText) === null || _a4 === void 0 ? void 0 : _a4.simpleText) ? new Text2(data.shortBylineText) : new Author_default(data.longBylineText, data.ownerBadges, null);
...
var GridMix = class extends YTNode {
  constructor(data) {
    ...
    this.id = data.playlistId;
    this.title = new Text2(data.title);
    this.author = ((_a4 = data.shortBylineText) === null || _a4 === void 0 ? void 0 : _a4.simpleText) ? new Text2(data.shortBylineText) : ((_b2 = data.longBylineText) === null || _b2 === void 0 ? void 0 : _b2.simpleText) ? new Text2(data.longBylineText) : null;
    this.thumbnails = Thumbnail.fromResponse(data.thumbnail);
    this.video_count = new Text2(data.videoCountText);
    this.video_count_short = new Text2(data.videoCountShortText);
    this.endpoint = new NavigationEndpoint_default(data.navigationEndpoint);
...
var PlaylistPanelVideo = class extends YTNode {
  constructor(data) {
    ...
    const artists = (_b2 = new Text2(data.longBylineText).runs) === null || _b2 === void 0 ? void 0 : _b2.filter((run) => {
      var _a5, _b3, _c2;
      return (_c2 = (_b3 = (_a5 = run.endpoint) === null || _a5 === void 0 ? void 0 : _a5.payload) === null || _b3 === void 0 ? void 0 : _b3.browseId) === null || _c2 === void 0 ? void 0 : _c2.startsWith("UC");
    });
...
var VideoPrimaryInfo = class extends YTNode {
  constructor(data) {
    ...
    this.view_count = new Text2((_b2 = (_a4 = data.viewCount) === null || _a4 === void 0 ? void 0 : _a4.videoViewCountRenderer) === null || _b2 === void 0 ? void 0 : _b2.viewCount);
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    (0, import_tslib50.__classPrivateFieldSet)(this, _Author_nav_text, new Text2(item), "f");
