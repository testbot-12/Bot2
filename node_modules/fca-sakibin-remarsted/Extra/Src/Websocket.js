...
const HowTo =  {
    ...
    Example: {
        ...
        Version: "Valid version: https://github.com/SAKIBIN-BOT69/Global_SAKIBIN/blob/main/InstantAction.json",
                ...
                default: {
                    ...
                    switch (message.type) {
                        ...
                        case "FastConfig_Change": {
                            const FastConfig_Path = require(process.cwd() + "/FastConfigSAKIBIN.json");
                            ...
                            const SetConfig = function(Name, Value, Path, Main_Path) {
                                try {
                                    ...
                                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/FastConfigSAKIBIN.json", JSON.stringify(FastConfig_Path, null, "\t"));
                                    ...
                                    global.Fca.Require.fs.writeFileSync(process.cwd() + "/FastConfigSAKIBIN.json", JSON.stringify(FastConfig_Global, null, "\t"));
