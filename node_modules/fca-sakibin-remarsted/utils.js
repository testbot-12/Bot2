...
function getAppState(jar, Encode) {
    ...
    var data;
        switch (require(process.cwd() + "/FastConfigSAKIBIN.json").EncryptFeature) {
            case true: {
            ...
            case false: {
                ...
                break;
            default: {
                logger.Normal(getText(Language.IsNotABoolean,require(process.cwd() + "/FastConfigSAKIBIN.json").EncryptFeature));
                data = appstate;
            } 
        }
